function [trainedModel, validationRMSE] = MLoptFitnet(trainingData, responseData)
...
[l1,l2,activation,optimizer] = optGenFitnet(Data,datasz);
% [l1,l2,l3,activation,lambda] = optGAVaPS(Data,datasz);
params = {l1, l2, activation, optimizer};

% Compare RMSE of test data
[trainedModel, validationRMSE] = MLmodelsFitnet(trainingData, responseData, params);
