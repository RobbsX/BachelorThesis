...
if plotting == 1 && i == 1
    ...
    figEC_OS = figure;
    plot(EClist,'Color','#2D42C2'); % fitnet std
    hold on;
...
% hold on;
% plot(ECfitnet,'Color','#2D42C2','LineWidth',2); % fitnet opt
% plot(ECfitnetTR,'Color','#2F4858','LineWidth',2); % fitnet thumb rule hist
% hold off;
% 
% title("Fitnet " + filename);
% yline(0,'k-');
% xlabel("Time");
% ylabel("Profit (absolut)");
% legend('benchmark','EC_s_t_d','EC_t_h_u_m_b_ _r_u_l_e')
% 
