function [P] = GrecombineBB(P, pCross, one_or_two_point, bit_size, rng, datasz)
% P...................Population Matrix
...
for zz = 1:length(idx)/2
    ...
    if one_or_two_point == 1
        ...
        while boolean1 == 0 || boolean2 == 0
            ...
            boolean1 = GcheckConstrBB(c1, bit_size, rng, datasz);
            boolean2 = GcheckConstrBB(c2, bit_size, rng, datasz);
        end
