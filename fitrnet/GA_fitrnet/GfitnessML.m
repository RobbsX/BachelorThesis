function [P, P_dec] = GfitnessML(data, P, bit_size, rng)
...
for ii = 1:length(P) %parfor
    ...
    lambda = P_oneline{4}; %FEHLER: nicht round()!!!
    params = {l1,l2,activation,lambda};
    
    % Calculate the fitness value 
    [~, validationRMSE] = MLmodels(trainingData, responseData, 'NN', params);
